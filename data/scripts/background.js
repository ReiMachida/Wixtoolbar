...
Wix.main = new WIXClass({
    ...
    view : {
        login : function(){
            ...
            if(Wix.option.get('Main', 'thumbnail_on')){
              thumbnailTick = Extension.UI.createElement("input",{
                'id' : 'wix-thumbnail-on',
                'type' : 'checkbox',
                'checked' : 'checked'
                });  
            ...
            $(thumbnailTick).addClass("wix-option:" + Wix.option.get('Main', 'thumbnail_on'));

            array.push(thumbnailTick);
